	...
	<body>
		...
		<?php
				...
				if($_SERVER['REQUEST_METHOD'] == "POST"){
					...
					$sql = "INSERT INTO instituut (instituut, telefoonnummer) VALUES (:instituut, :telefoonnummer)";
					...
					$db = new database();
					$db->insert($sql, $placeholder, 'overzicht_instituten.php');
		...
		<div class="content">
			<form action="overzicht_instituten_add.php" method="POST" class="form">
				<h3>Voeg Instituut Toe</h3><br>
				<p>Instituut Naam</p>
				<input type="text" name="instituut" required><br>
				<p>Instituut Telefoonnummer</p>
